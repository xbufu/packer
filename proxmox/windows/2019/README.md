...
3. Add any scripts you want to run at the bottom of [windows-server-2019.json](windows-server-2019.json). 
...
```
packer validate -var-file ..\..\proxmox-credentials.json -var-file .\vm-config.json .\windows-server-2019.json
```

### Create the template

```
packer build -var-file ..\..\proxmox-credentials.json -var-file .\vm-config.json .\windows-server-2019.json
 ```
