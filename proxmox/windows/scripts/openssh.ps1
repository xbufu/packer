...
# ensure bufu can log in
Write-Output "Setting bufu user file permissions"
New-Item -ItemType Directory -Force -Path "C:\Users\bufu\.ssh"
C:\Windows\System32\icacls.exe "C:\Users\bufu" /grant "bufu:(OI)(CI)F"
C:\Windows\System32\icacls.exe "C:\Program Files\OpenSSH\bin" /grant "bufu:(OI)RX"
C:\Windows\System32\icacls.exe "C:\Program Files\OpenSSH\usr\sbin" /grant "bufu:(OI)RX"
...
# disabled for vcloud to make bufu-serverspec work
...
C:\Windows\System32\icacls.exe "C:\Windows\Temp" /grant "bufu:(OI)(CI)F"
...
Set-Content C:\Users\bufu\.ssh\environment $sshenv
